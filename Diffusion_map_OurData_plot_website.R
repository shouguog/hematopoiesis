...
plot3d(mapping[,1], mapping[,2], mapping[,3], size = 2, col = colors,
       type="s",xlab="DM1",ylab = "DM2",zlab="DM3")
writeWebGL(dir="./", filename = "PCR_GATA1.html", width=600, height = 600)
attr("PCR_GATA1.html", "reuse")
...
plot3d(mapping[,1], mapping[,2], mapping[,3], size = 2, col = colors,
       type="s",xlab="DM1",ylab = "DM2",zlab="DM3")
writeWebGL(dir="./", filename = "PCR_MEIS1.html", width=600, height = 600)
attr("PCR_MEIS1.html", "reuse")
