...
pdInterest<-pdInterest[order(pdInterest$Pseudotime),]
...
write.csv(sumData, file = "sumData_HSCtoMEP_rep1.csv", quote = FALSE, row.names = FALSE)
save(result, X, file = "result_HSCtoMEP_rep1.RData")
